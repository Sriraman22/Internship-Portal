...
export declare const AZURE_MONITOR_OPENTELEMETRY_VERSION = "1.13.0";
 ...
 * @internal
 */
export declare const APPLICATIONINSIGHTS_SDKSTATS_ENABLED_PREVIEW = "APPLICATIONINSIGHTS_SDKSTATS_ENABLED_PREVIEW";
